...
import { IoHeartOutline,IoArrowUp } from "react-icons/io5";
  ...
  return (
    <div className="relative md:max-w-[500px] m-auto  h-[100vh] max-h-[100vh] md:max-h-[91vh] flex items-center justify-center md:first:mt-5">
      <div className="relative w-full h-full  md:rounded-md overflow-hidden  mt-5 mb-10 md:shadow-[0_0_15px_rgba(0,0,0,0.25)]  ">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 p-4 bg-gradient-to-t from-black/70 to-transparent">
          <div className="space-y-2 mb-3">
            ...
            <Link href={'https://www.toastd.in/'} className=" w-full md:w-auto bg-white text-black font-medium px-6 py-2.5 rounded-full hover:bg-white/90 transition-all">
              View Product
            </Link>
          </div>
        </div>
      ...
      <div className="absolute right-4 md:right-[-60px] bottom-32 md:bottom-24 md:top-auto z-20 flex flex-col  gap-2 md:gap-3 ">
        <button className=" rounded-full flex justify-center items-center content-center text-center p-2 cursor-pointer bg-transparent hover:bg-zinc-400/50">
          <IoHeartOutline className="w-7 h-7  text-white md:text-black  " />
        </button>
